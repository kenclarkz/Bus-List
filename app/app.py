...
def register_routes(app):
    ...
    def inject_globals():
        ...
        # "futuristic"|"halloween"|"bloomberg") to the value used in the
        # data-theme attribute. CSS defines dark styles for "dark" and the
        # special themes, so "on" must map to "dark"; "system" is resolved
        # live by the browser.
