...
DEFAULTS = {
    ...
    "dark_mode": "off",       # global fallback theme: off | on | system | futuristic | halloween | bloomberg | synthwave | cosmos | cyberpunk
...
THEME_CHOICES = (
    "off", "on", "system", "futuristic", "halloween", "bloomberg",
    "synthwave", "cosmos", "cyberpunk",
)
